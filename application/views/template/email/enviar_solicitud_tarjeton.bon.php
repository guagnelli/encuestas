<div style="color:#333;">
    <p>Estimado(a) <?php echo $emp_nom_completo; ?>,</p>
    <p>Le agradecemos por participar en los Talleres de actualizaci&oacute;n para el uso de los recursos de informaci&oacute;n en salud. Su registro al taller fue realizado exitosamente, a continuaci&oacute;n, le mostramos el detalle de su inscripci&oacute;n:</p>
    <p>Nombre: <b><?php echo $emp_nom_completo; ?></b></p>
    <p>Matricula: <b><?php echo $matricula; ?></b></p>
